...
You can download the lecture notes [here](./main.pdf) - the core PDF covering tools from probability theory and the foundations of ergodicity economics.

If you want to discuss the lecture notes you can join the [Discord server](https://discord.gg/TcnesY8) - community chat for questions, discussion, and study groups.
...
### Ole Peters -- Recent Papers

- [The ergodicity solution of the cooperation puzzle](https://royalsocietypublishing.org/doi/10.1098/rsta.2020.0425) -- Peters & Adamou (Philosophical Transactions of the Royal Society A, 2022)
- [Insurance as an ergodicity problem](https://www.cambridge.org/core/journals/annals-of-actuarial-science/article/insurance-as-an-ergodicity-problem/193215EAD7D1731B81EB8A61C99804D0) -- Peters (Annals of Actuarial Science, 2023)
- [Ergodicity economics -- a history](https://ergodicityeconomics.com/2024/02/05/ergodicity-economics-a-history-2/) -- Peters (Ergodicity Economics blog, 2024)

### The Textbook

- [An Introduction to Ergodicity Economics](https://www.amazon.com/Introduction-Ergodicity-Economics-Ole-Peters/dp/1068649135) -- Peters & Adamou (LML Press, 2025)

### Experimental Evidence

- [Ergodicity-breaking reveals time optimal decision making in humans](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1009217) -- Meder, Rabe et al. (PLOS Computational Biology, 2021)
- [The influence of ergodicity on risk affinity of timed and non-timed respondents](https://www.nature.com/articles/s41598-022-07613-6) -- Vanhoyweghen et al. (Scientific Reports, 2022)

### Critiques & Debates

- ['Ergodicity Economics' is Pseudoscience](https://arxiv.org/abs/2306.03275) -- Toda (arXiv, 2023)
- [The Limitations of Growth-Optimal Approaches to Decision Making Under Uncertainty](https://econjwatch.org/articles/the-limitations-of-growth-optimal-approaches-to-decision-making) -- Ford & Kay (Econ Journal Watch, 2023)
